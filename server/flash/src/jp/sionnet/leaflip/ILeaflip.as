...
package jp.sionnet.leaflip 
{
	...
	/**
	 * <p>マウス操作でページをめくる、閉じるなどの機能を持つインターフェイス。</p>
	 * 
	 ...
	 */
	public interface ILeaflip extends ILeaflipBase
	{
		/**
		 ...
		 */
		function get allowFlip():Boolean;
		function set allowFlip(boolean:Boolean):void;
	}
