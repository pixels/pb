...
package jp.sionnet.leaflip 
{
	 ...
	 */
	public class BookflipEvent extends Event
	{
		/**
		 * <p>ページ移動後、Tween処理終了時のclosecompleteイベントオブジェクトの値を定義します。</p>
		 */
		public static const MOVE_COMPLETE:String = "movecomplete";
		
		public function BookflipEvent(type:String, bubbles:Boolean = true, cancelable:Boolean = false) 
		{
