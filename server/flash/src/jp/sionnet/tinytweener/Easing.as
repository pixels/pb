...
package jp.sionnet.tinytweener 
{
	...
	public class Easing
	{
		...
		public static const CUBIC_IN:String = "easeInCubic";
		public static const CUBIC_OUT:String = "easeOutCubic";
		
		public function Easing() 
		{
			if (getQualifiedClassName(this) == "jp.sionnet.tinytweener::TinyTweener")
			{
				throw new ArgumentError("このクラスは定数を提供します。インスタンス化できません");
			}
		}
